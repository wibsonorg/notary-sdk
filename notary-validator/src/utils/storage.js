...
export const listLevelPairs = store =>
  listLevelStream(store.createReadStream());
export const listLevelKeys = store =>
  listLevelStream(store.createKeyStream());
export const listLevelValues = store =>
  listLevelStream(store.createValueStream());
