    ...
    it('responds with a correct signature', (done) => {
      requestPost(
        ...
        '/buyers/audit/consent', {
          ...
          expect(res.body.signature).to.be.equal('0x011da84640d4861207270e21' +
          '2cb619c2bc' +
          'af5c3994f94417f74471d72a43135f4652ce3ab088' +
          '79787429a99209e82ff0f7a621d4253f0' +
          '6a297f6714c1ac977b51c');
        },
      );
    });
  });
...
describe('#POST /buyers/audit/result', () => {
  ...
  context('with all the payload', () => {
    const signature = '0x03344d319275dfca74f241452910c75040a' +
    '45f54bd6fee4f5dae5' +
    '061f65e9c4a1ee66f911f40e1a2b16867e3cd03baac99fee4effa3fba1fa55c7' +
    '4e13aea1f6c1b';
